function myFunction() {
    ...
    if (persona == null || person == "") {
        ...
        txt = "Three people are on the run from the police:" + persona + "," + personb + "," + personc + 
            ...
            persona + "runs to hide with the cows." + personb + "runs to hide with the chickens." + personc + 
            "runs to hide in the potato sack. The police catch up and come into the barn. They walk towards the cows and ask, 
            \"Is anybody there?\"" + persona + "goes \"Mooo mooo.\" The police think, 
